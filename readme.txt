...
Finally, simply type in "localhost" into a browser, and you should see index.php, which shows the HTML, CSS, and Vue.js programming in a visible format. The CSS was compiled form a LESS file, which is present in a folder titled "less" in the root directory. When an email is successfully entered, you will be brought to the backend page, "database.php", where you can look at the emails submitted, as well as sort and delete them. 
